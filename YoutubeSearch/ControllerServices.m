...
//    obj1.localName = @"TanTan";
//    obj1.isFromBundle = true;
//    obj1.bundleName = @"audio1";
//    obj1.bundleExt = @"caf";
//    obj1.duration = 8;
//    [__deviceSources addObject:obj1];
//
//    DeviceMediaModel* obj2 = [[DeviceMediaModel alloc]init];
//    obj2.iid = [DeviceMediaModel randomID];
//    obj2.localName = @"AAC";
//    obj2.isFromBundle = true;
//    obj2.bundleName = @"aac_song_file";
//    obj2.bundleExt = @"aac";
//    obj2.duration = 204;
//    [__deviceSources addObject:obj2];
    
    DeviceMediaModel* obj1 = [[DeviceMediaModel alloc]init];
    obj1.iid = [DeviceMediaModel randomID];
    obj1.localName = @"Shape of You";
    obj1.isFromBundle = true;
    obj1.bundleName = @"Ed Sheeran - Shape of You";
    obj1.bundleExt = @"mp3";
    obj1.duration = 235;
    [__deviceSources addObject:obj1];
    ...
    DeviceMediaModel* obj2 = [[DeviceMediaModel alloc]init];
    obj2.iid = [DeviceMediaModel randomID];
    obj2.localName = @"Sorry";
    obj2.isFromBundle = true;
    obj2.bundleName = @"Justin Bieber - Sorry";
    obj2.bundleExt = @"mp3";
    obj2.duration = 199;
    [__deviceSources addObject:obj2];
...
+ (void)playAudio:(DeviceMediaModel*)audio inList:(NSArray<DeviceMediaModel*>*)playlist{
    ...
    [CrashlyticsKit setObjectValue:audio forKey:[NSString stringWithFormat: @"%d", (int)tI]];
