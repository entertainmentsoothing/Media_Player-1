...
+ (instancetype)loadSession{
    ...
    NSData * sessionData = [UICKeyChainStore dataForKey:@"com.test"];
    AppSession *session = [NSKeyedUnarchiver unarchiveObjectWithData: sessionData];
...
+ (void)saveSession:(id)session{
    ...
    [UICKeyChainStore setData:sessionData forKey:@"com.test"];
