...
//                             imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    ...
    if(![[NSUserDefaults standardUserDefaults] boolForKey:@"OEPNED_RATING_PLAYLIST"]) {
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"OEPNED_RATING_PLAYLIST"];
...
//        return [AppSession sharedInstance].playlists.count;
        return ([AppDefine sharedInstance].internetReachability.currentReachabilityStatus == NotReachable) ? 0 : [AppSession sharedInstance].playlists.count;
    }
