...
//                             imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    ...
    if(![[NSUserDefaults standardUserDefaults] boolForKey:@"OEPNED_RATING_FAVORITE"]) {
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"OEPNED_RATING_FAVORITE"];
...
//        return [AppSession sharedInstance].favorite.datas.count;
        return ([AppDefine sharedInstance].internetReachability.currentReachabilityStatus == NotReachable) ? 0 : [AppSession sharedInstance].favorite.datas.count;
    }
