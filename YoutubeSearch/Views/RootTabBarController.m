...
@interface RootTabBarController ()<AudioEQControllerDelegate, UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource, AudioTableViewCellDelegate, AudioPlayerControllerDelegate, UITabBarControllerDelegate>
...
- (void) showRewardedVideo {
    if ([[GADRewardBasedVideoAd sharedInstance] isReady]) {
        [AppDefine sharedInstance].isInAD = YES;
...
- (void) showReachabilityAlert {
    if ([Reachability reachabilityForInternetConnection].currentReachabilityStatus == NotReachable) {
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Error" message:@"Either Cellular data or Wifi is required to be enabled in order to use the app." preferredStyle:UIAlertControllerStyleAlert];
...
//    else{
//        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Reachable" message:@"Either Cellular data or Wifi is required to be enabled in order to use the app." preferredStyle:UIAlertControllerStyleAlert];
//        UIAlertAction *action = [UIAlertAction actionWithTitle:@"Ok" style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
//            
//        }];
//        [alertController addAction:action];
...
- (void)showOneTimeAlert {
    NSString *im = [UICKeyChainStore stringForKey:@"com.importantmessage"];
    if (im == nil) {
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Important Message" message:@"Playlists, Favorites & Library activity from past version will reset & will not display on this new version. The process to prevent this reset issue that occurs when a new version is available has been addressed & from this version and on Playlist, Favorites & Library activity will not reset. We apologize for the disruption." preferredStyle:UIAlertControllerStyleAlert];
        UIAlertAction *action = [UIAlertAction actionWithTitle:@"Ok" style:UIAlertActionStyleCancel handler:^(UIAlertAction * _Nonnull action) {
        ...
        [UICKeyChainStore setString:@"done" forKey:@"com.importantmessage"];
    }
}
